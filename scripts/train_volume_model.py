...
if __name__ == "__main__":
    ...
    model.add_layers(25, layer_type=reg.MLPLayerType.dense(), activation=reg.Activations.relu())
    model.add_layers(20, layer_type=reg.MLPLayerType.dense(), activation=reg.Activations.relu())
    model.add_layers(18, layer_type=reg.MLPLayerType.dense(), activation=reg.Activations.relu())
    model.set_model()
    acc = model.fit(x, y)
